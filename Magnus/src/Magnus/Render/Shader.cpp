...
namespace Magnus {
    ...
    ShaderProgramSource Shader::ParseShader(const std::string& VerPath, const std::string& FraPath) {
    ...
    unsigned int Shader::CreateShader(const std::string& vertexShader, const std::string& fagmentShader) {
